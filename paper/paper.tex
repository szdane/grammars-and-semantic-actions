...
similar role to the $!$ modality of ordinary linear logic or the
persitent modality $\square$ from separation logic.
...
\begin{definition}
  ...
  $P$ and functions $I \xleftarrow f P \xrightarrow g S  \xrightarrow h O$. The \emph{extension}
...
Kleene star.  More generally, they are defined as an inequational theory
...
\pedro{As a rule of thumb, I don't think that sketching these ideas
will get us anything...}
