...
For reasons of brevity, we present only a selection of cases here. The full details are in the appendix.\max{todo: put the full details in the appendix}.
...
\begin{enumerate}
  ...
  \item A non-linear term $\Gamma \vdash e : X$ denotes a dependently typed function
        $\sem e : \prod_{\gamma : \sem \Gamma}\sem{X} \gamma$ \pedro{we have not defined what sections are}
